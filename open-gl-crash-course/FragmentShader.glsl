...
void main() {
	...
	float specularStrength = 0.8; // idensity of the light spot in the object surface
	...
	float specularFactor = pow(max(dot(viewDir, reflectDir), 0), 256); // 32 is the shininess value
