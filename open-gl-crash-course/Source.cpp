...
int main() {
	...
	*/
	...
	Shader shaderLight("bloom_vs.glsl", "light_box_fs.glsl");
	...
	unsigned int containerTexture = generateTexture("Textures/container2.png", false);
	...
	// Render with multiple colorbuffers
